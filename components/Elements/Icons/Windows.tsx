...
const Windows = ({ className, width, height, fill }: SVGAttributes<SVGElement>) => (
  <svg
    className={className}
    width={width}
    height={height}
  ...
  >
    ...
    <linearGradient
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset="0" stopColor="#54daff" />
      <stop offset="1" stopColor="#25a2e5" />
    </linearGradient>
    <path fill="url(#RucpB_ahqt8VfTW7X2sDFd)" d="M22,7.973V23h20.995V7.303c0-1.216-1.076-2.151-2.28-1.98L22,7.973z" />
  </svg>
);
