...
const Footer = () => {
  ...
  return (
    <section className="footerContainer">
      <p
        className="contact"
        dangerouslySetInnerHTML={{ __html: FOOTER_INTRO }}
        role="button"
        onClick={clickToCopy}
      />
      <footer className="footer">
        <RouteLink href="https://www.npmjs.com/~sprakash57" isExternal>
          <figure className="socialIcon">
            <Image
              src={require("@/public/icons/npm.svg")}
              alt="NPM"
              title="NPM"
              width={20}
              height={20}
        ...
        <RouteLink
          href="https://play.google.com/store/apps/developer?id=Sunny+Prakash"
          isExternal
        >
          <figure className="socialIcon">
            <Image
              src={require("@/public/icons/playstore.svg")}
              alt="Play Store"
              title="Play store"
              width={20}
              height={20}
        ...
        <RouteLink href="https://dev.to/sprakash57" isExternal>
          <figure className="socialIcon">
            <Image
              src={require("@/public/icons/dev.svg")}
              alt="Dev.to"
              title="Dev.to"
              width={20}
              height={20}
        ...
        <RouteLink
          href="http://www.linkedin.com/in/sunny-prakash-3780ba49"
          isExternal
        >
          <figure className="socialIcon">
            <Image
        ...
        <RouteLink
          href="https://stackoverflow.com/users/9585068/sunny-prakash"
          isExternal
        >
          <figure className="socialIcon">
            <Image
              src={require("@/public/icons/stackoverflow.svg")}
              alt="Stackoverflow"
              title="Stackoverflow"
              width={20}
              height={20}
