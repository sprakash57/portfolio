...
export const workDone = [
    ...
    },
    {
        ...
        "body": `Serverless solution to contact form. The motivation behind creating it was to add a contact form to my
         static website without maintaining a server.🚀`
    },
    {
        "id": "villain",
        "url": villain,
        ...
        extraction process. I added localization feature to the app with react-localization. My PR was merged successfully. 📕📚`
    },
    {
        "id": "coonect3",
        "url": coonect3,
        "title": "Connect 3",
        "stack": "AndroidX, Android Studio, Java 🎮",
    ...
    },
    {
        ...
        only react-native-cli features. It is up and running in production. 🏏`
    },
    {
        "id": "userSearch",
        "url": userSearch,
