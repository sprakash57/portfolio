  ...
  return (
    <Layout header={Sections.Contact}>
      <p className={s.contactPara}>
        ...
        here. These are great way to say &quot;Hi!&quot; and discuss about career opportunities, web development, Mobile apps
        development, or maybe general discussion. I would be more excited if our discussion includes React ecosystem,
